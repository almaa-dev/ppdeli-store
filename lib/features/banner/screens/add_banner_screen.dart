...
import 'package:ppdelistore/features/banner/controllers/banner_controller.dart';
import 'package:ppdelistore/features/banner/domain/models/store_banner_list_model.dart';
import 'package:ppdelistore/helper/url_validator.dart';
      ...
      for (int index = 0; index < _languageList.length; index++) {
        ...
        for (var translation in widget.storeBannerListModel!.translations!) {
          if (_languageList[index].key == translation.locale &&
            ...
            _titleController[index] = TextEditingController(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    CustomTextFieldWidget(
                                      ...
                                      showLabelText: false,
                                      controller:
                                          _titleController[_tabController!
                                              .index],
                                      capitalization: TextCapitalization.words,
                                      focusNode:
                                          _titleFocusNode[_tabController!
                                              .index],
                                      nextFocus:

...
import 'package:ppdelistore/features/deliveryman/domain/services/deliveryman_service_interface.dart';
...
class DeliveryManController extends GetxController implements GetxService {
  ...
  Future<void> getDeliveryManList() async {
    List<DeliveryManModel>? deliveryManList = await deliverymanServiceInterface
        .getDeliveryManList();
  ...
  Future<void> deleteDeliveryMan(int? deliveryManID) async {
    _isLoading = true;
    update();
    bool isSuccess = await deliverymanServiceInterface.deleteDeliveryMan(
      deliveryManID,
    );
    if (isSuccess) {
      Get.back();
  ...
  Future<void> getDeliveryManReviewList(int? deliveryManID) async {
    _dmReviewList = null;
    List<ReviewModel>? dmReviewList = await deliverymanServiceInterface
  ...
  void pickImage(bool isLogo, bool isRemove) async {
    if (isRemove) {
      ...
      if (isLogo) {
        ...
        XFile? pickedIdentitiesImage = await deliverymanServiceInterface

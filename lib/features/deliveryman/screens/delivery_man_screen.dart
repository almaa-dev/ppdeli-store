    ...
    return GetBuilder<ProfileController>(
      builder: (profileController) {
        return Scaffold(
          ...
          floatingActionButton: profileController.modulePermission!.deliveryman!
          ...
          body: profileController.modulePermission!.deliverymanList!
              ? GetBuilder<DeliveryManController>(
                    ...
                    return dmController.deliveryManList != null
                        ? dmController.deliveryManList!.isNotEmpty
                              ? ListView.builder(
                                  ...
                                  itemCount:
                                      dmController.deliveryManList!.length,

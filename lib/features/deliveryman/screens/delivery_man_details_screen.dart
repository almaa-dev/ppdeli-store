import 'package:ppdelistore/features/deliveryman/controllers/deliveryman_controller.dart';
...
import 'package:ppdelistore/features/deliveryman/widgets/amount_card_widget.dart';
...
class DeliveryManDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<DeliveryManController>(
                        ...
                        children: [
                          ...
                          dmController.dmReviewList != null
                              ? dmController.dmReviewList!.isNotEmpty
                                    ? ListView.builder(
                                        itemCount:
                                            dmController.dmReviewList!.length,
                                        physics:
                  ...
                  Get.dialog(
                    ConfirmationDialogWidget(
                      ...
                      description: dmController.isSuspended
                          ? 'are_you_sure_want_to_un_suspend_this_delivery_man'
                                .tr

import 'package:ppdelistore/features/auth/domain/models/module_permission_model.dart';
...
import 'package:ppdelistore/features/menu/domain/models/menu_model.dart';
...
import 'package:ppdelistore/features/menu/widgets/menu_button_widget.dart';
...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.find<SplashController>()
            .configModel!
            .reelsModule
            ?.vendorCanUploadReels ==
        true) {
      menuList.add(
        MenuModel(
          icon: Images.reels,
          title: 'reels'.tr,
          route: RouteHelper.getReelsRoute(),
        ),
      );
    }
    menuList.add(
    ...
    // 🖨 Printers — placed right before Logout per the spec.
    menuList.add(
      MenuModel(
        icon: Images.pos,
        title: 'printers'.tr,
        route: RouteHelper.getPrinterRoute(),
      ),
    );

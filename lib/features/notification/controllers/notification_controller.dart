import 'package:ppdelistore/features/notification/domain/models/notification_model.dart';
import 'package:ppdelistore/helper/date_converter_helper.dart';
import 'package:get/get.dart';
import 'package:ppdelistore/features/notification/domain/services/notification_service_interface.dart';
  ...
  Future<void> getNotificationList() async {
    ...
    if (notificationList != null) {
      ...
      _notificationList!.sort((NotificationModel n1, NotificationModel n2) {
        return DateConverterHelper.dateTimeStringToDate(
          n1.createdAt!,
        ).compareTo(DateConverterHelper.dateTimeStringToDate(n2.createdAt!));
      });

...
class OutOfStockWarningBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    int outOfStockCount =
        Get.find<ProfileController>().profileModel!.outOfStockCount!;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      text: outOfStockCount > 3
                          ? '${outOfStockCount > outOfStockCount - 1 ? '${outOfStockCount - 1}${'more'.tr}' : outOfStockCount}'
                      ...
                      children: [
                        TextSpan(
                          text: outOfStockCount > 3
                              ? ' ${outOfStockCount > outOfStockCount - 1 ? 'products_are_low_on_stock'.tr : 'product_is_low_on_stock'.tr}'
                              : 'product_is_low_on_stock'.tr,

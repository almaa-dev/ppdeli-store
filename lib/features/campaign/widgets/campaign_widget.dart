...
import 'package:ppdelistore/features/campaign/domain/models/campaign_model.dart';
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          if (campaignModel.vendorStatus == null) {
                            Get.dialog(
                              ConfirmationDialogWidget(
                                ...
                                adminText: '',
                                onYesPressed: () {
                                  Get.find<CampaignController>().joinCampaign(
                                    campaignModel.id,
                                    false,
                                  );
                                },
                          ...
                          } else if (campaignModel.vendorStatus ==
                              'confirmed') {
                            Get.dialog(
                              ConfirmationDialogWidget(
                                icon: Images.warning,
                                ...
                                adminText: '',
                                onYesPressed: () {
                                  Get.find<CampaignController>().leaveCampaign(
                                    campaignModel.id,
                                    false,
                                  );
                                },

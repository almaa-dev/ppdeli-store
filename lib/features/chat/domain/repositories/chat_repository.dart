...
import 'package:ppdelistore/features/chat/domain/models/message_model.dart';
import 'package:ppdelistore/features/chat/domain/repositories/chat_repository_interface.dart';
...
class ChatRepository implements ChatRepositoryInterface {
  ...
  Future<MessageModel?> getMessages(
    ...
    Response response = await apiClient.getData(
      '${AppConstants.getMessageListUri}?offset=$offset&limit=10&${conversationID != null
          ? 'conversation_id'
          : userType == AppConstants.deliveryMan
          ? 'delivery_man_id'
  ...
  Future<MessageModel?> sendMessage(
    ...
    Response response = await apiClient
        .postMultipartData(AppConstants.sendMessageUri, {
          'message': message,

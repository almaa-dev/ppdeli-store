    ...
    return GetBuilder<AddressController>(
      builder: (addressController) {
        ...
        if (addressController.moduleList != null) {
          for (
            int index = 0;
            index < addressController.moduleList!.length;
            index++
          ) {
                ...
                DropdownItem<int>(
                  ...
                  child: SizedBox(
                    child: Padding(
                      ...
                      child: Text(
                        '${addressController.moduleList![index].moduleName}',
                      ),
                    ),
                  ),
                ),
        ...
        return addressController.moduleList != null
            ? Stack(
                    ...
                    child: CustomDropdown<int>(
                      onChange: (int? value, int index) {
                        ...
                        Get.find<AuthController>().getPackageList(
                          moduleId: addressController.moduleList![value!].id,
                        );
                      },

import 'package:ppdelistore/common/widgets/custom_youtube_player_widget.dart';
...
import 'package:ppdelistore/features/store/widgets/update_stock_bottom_sheet.dart';
import 'package:ppdelistore/features/store/widgets/variation_view_widget.dart';
...
import 'package:ppdelistore/features/store/widgets/review_widget.dart';
...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> additionalImages = (item.imagesFullUrl ?? <String?>[])
        .whereType<String>()
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (videoLink.isNotEmpty ||
                            videoFullUrl.isNotEmpty) ...[
                          InkWell(
                            onTap: () {
                              if (videoLink.isNotEmpty) {
                                Get.to(
                                  () => CustomYoutubePlayerPage(
                                    videoUrl: videoLink,
                                    title: videoLink,
                                  ),
                                );

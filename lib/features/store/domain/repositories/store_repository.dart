...
import 'package:ppdelistore/features/store/domain/repositories/store_repository_interface.dart';
  ...
  Future<bool> updateStore(
    ...
    fields.addAll(<String, String>{
      ...
      'minimum_stock_for_warning':
          store.minimumStockForWarning?.toString() ?? '0',
    });
  ...
  Future<Response> addItem(
    ...
    if (Get.find<ProfileController>()
      ...
      fields.addAll((<String, String>{
        ...
        'meta_max_video_preview':
            item.metaData?.metaMaxVideoPreview.toString() ?? '',
        'meta_max_video_preview_value':
            item.metaData?.metaMaxVideoPreviewValue.toString() ?? '',
        'meta_max_image_preview':
            item.metaData?.metaMaxImagePreview.toString() ?? '',
        'meta_max_image_preview_value':
            item.metaData?.metaMaxImagePreviewValue ?? '',
      }));
    ...
    if (!isAdd) {
      final bool hasReplacementVideo =
          video != null || (isVideoLink && trimmedVideoLink.isNotEmpty);

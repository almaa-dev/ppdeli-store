...
import 'package:ppdelistore/features/disbursement/domain/repositories/disbursement_repository_interface.dart';
...
class DisbursementRepository implements DisbursementRepositoryInterface {
  ...
  Future<bool> addWithdraw(Map<String?, String> data) async {
    Response response = await apiClient.postData(
      AppConstants.addWithdrawMethodUri,
      data,
    );
  ...
  Future<disburse.DisbursementMethodBody?> getList() async {
    ...
    Response response = await apiClient.getData(
      '${AppConstants.disbursementMethodListUri}?limit=10&offset=1',
    );
  ...
  Future<bool> makeDefaultMethod(Map<String?, String> data) async {
    Response response = await apiClient.postData(
      AppConstants.makeDefaultDisbursementMethodUri,
      data,
    );
    return (response.statusCode == 200);
  }

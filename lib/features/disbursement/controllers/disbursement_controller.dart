...
import 'package:ppdelistore/features/disbursement/domain/models/disbursement_method_model.dart'
    as disburse;
import 'package:ppdelistore/features/disbursement/domain/models/disbursement_report_model.dart'
    as report;
...
import 'package:ppdelistore/features/disbursement/domain/services/disbursement_service_interface.dart';
...
class DisbursementController extends GetxController implements GetxService {
  ...
  Future<void> setMethod({bool isUpdate = true, bool initCall = false}) async {
    ...
    if (Get.find<PaymentController>().widthDrawMethods == null) {
      _widthDrawMethods = await Get.find<PaymentController>()

...
import 'package:ppdelistore/common/widgets/item_shimmer_widget.dart';
import 'package:ppdelistore/common/widgets/item_widget.dart';
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        if (Get.find<CategoryController>().offset < pageSize) {
          Get.find<CategoryController>().setOffset(
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                categoryController.itemList != null
                    ? categoryController.itemList!.isNotEmpty
                          ? GridView.builder(
                              key: UniqueKey(),
                              gridDelegate:
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: ItemWidget(
                                    ...
                                    index: index,
                                    length: categoryController.itemList!.length,
                                    isCampaign: false,
                                    inStore: true,
                                  ),
                                );
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ItemShimmerWidget(
                            isEnabled: categoryController.itemList == null,
                            hasDivider: index != 19,
                          );
                        },
                      ),

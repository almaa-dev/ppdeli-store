...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    showLowStockCount =
        (json['show_low_stock_count'] == 1 ||
            json['show_low_stock_count'] == true)
        ? true
        : false;
    minimumStockForWarning =
        int.tryParse(json['minimum_stock_for_warning'].toString()) ?? 0;
    metaData = json['meta_data'] != null
        ? MetaSeoData.fromJson(json['meta_data'])
        : null;
    verifiedSeller =
        (json['verified_seller'] == 1 || json['verified_seller'] == true);
  }

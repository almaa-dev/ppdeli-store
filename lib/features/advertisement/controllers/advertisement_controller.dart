...
import 'package:ppdelistore/features/advertisement/domain/services/advertisement_service_interface.dart';
import 'package:get/get.dart';
import 'package:ppdelistore/features/advertisement/enums/ads_type.dart';
...
import 'package:ppdelistore/features/advertisement/widgets/ads_create_success_bottom_sheet.dart';
...
class AdvertisementController extends GetxController implements GetxService {
  ...
  Future<void> submitNewAdvertisement({
    ...
    Map<String, String> body = {
      ...
      'dates':
          "${DateConverterHelper.stringToMDY(dateTimeRange?.start.toString() ?? "")} - ${DateConverterHelper.stringToMDY(dateTimeRange?.end.toString() ?? "")}",
  ...
  Future<void> editAdvertisement(
    AdsDetailsModel advertisementData, {
  ...
  Future<bool> deleteAdvertisement(int id) async {
    _isLoading = true;
    update();
    bool? success = await advertisementServiceInterface.deleteAdvertisement(
      id: id,
    );
    if (success) {
      await getAdvertisementList('1', _type);
  ...
  Future<AdsDetailsModel?> getAdvertisementDetails({required int id}) async {
    ...
    AdsDetailsModel? adsDetailsModel = await advertisementServiceInterface
        .getAdvertisementDetails(id: id);
  ...
  Future<bool> changeAdvertisementStatus({
    ...
    _isLoading = true;
    update();
    bool success = await advertisementServiceInterface

...
import 'package:ppdelistore/common/widgets/custom_loader_widget.dart';
import 'package:ppdelistore/common/widgets/custom_snackbar_widget.dart';
import 'package:ppdelistore/features/advertisement/controllers/advertisement_controller.dart';
import 'package:ppdelistore/features/advertisement/models/ads_details_model.dart';
import 'package:ppdelistore/features/advertisement/models/advertisement_model.dart';
import 'package:ppdelistore/features/advertisement/models/popup_menu_model.dart';
import 'package:ppdelistore/features/advertisement/screens/create_advertisement_screen.dart';
import 'package:ppdelistore/features/advertisement/widgets/confirmation_bottom_sheet.dart';
import 'package:ppdelistore/features/advertisement/widgets/empty_ads_view.dart';
import 'package:ppdelistore/helper/date_converter_helper.dart';
import 'package:ppdelistore/helper/route_helper.dart';
import 'package:ppdelistore/helper/string_extensions.dart';
...
class _AdvertisementListScreenState extends State<AdvertisementListScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        int pageSize = (Get.find<AdvertisementController>().pageSize! / 10)
            .ceil();
        if (Get.find<AdvertisementController>().offset < pageSize) {
          Get.find<AdvertisementController>().setOffset(
            Get.find<AdvertisementController>().offset + 1,
          );
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return statusWidget(
                              ...
                              title:
                                  advertisementController.statusList[index].tr,
                              index: index,
                              count: count,
                            );
                          },
  ...
  Widget advertisementListWidget(
    AdvertisementController adsController,
    List<Adds>? advertisementList,
  ) {
    return GetBuilder<AdvertisementController>(
                ...
                itemBuilder: (context, index) {
                  if (index == advertisementList.length) {
                    return const SizedBox(
                      height: Dimensions.paddingSizeExtraOverLarge * 1.5,
                    );
                  }
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      advertisementList[index].addType!.tr
                                          .replaceAll('_', ' ')
                                          .toTitleCase(),
                                      style: robotoRegular.copyWith(

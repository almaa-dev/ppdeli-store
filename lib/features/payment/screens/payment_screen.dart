...
import 'package:ppdelistore/features/payment/widgets/fund_payment_dialog_widget.dart';
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        ...
        Get.find<ProfileController>().trialWidgetShow(
          route: RouteHelper.payment,
        );
      },
      child: Scaffold(
...
class MyInAppBrowser extends InAppBrowser {
  ...
  void _redirect(
    ...
    if (_canRedirect) {
      ...
      bool isFailed =
          url.contains('${AppConstants.baseUrl}/payment-fail') ||
          url.contains('${AppConstants.baseUrl}/success?flag=fail');
      bool isCancel =
          url.contains('${AppConstants.baseUrl}/payment-cancel') ||
